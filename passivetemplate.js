...
var hr = Java.type("org.parosproxy.paros.model.HistoryReference")
...
function scan(ps, msg, src) {
    ...
    // print("scanning");
    if ({condition}) {    // Change to a test which detects the vulnerability
...
function appliesToHistoryType(historyType) {
    ...
    // Default behaviour scans default types.
     print (historyType)
     print (hr.TYPE_PROXIED)

     if (historyType == hr.TYPE_PROXIED){
         return true}
     else {
         return false
     }
